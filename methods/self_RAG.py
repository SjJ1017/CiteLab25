...
if __name__ == "__main__":
    ...
    queryprompt = Prompt(
        template="<INST><question><prev><ans>Please generate one query to help find relevent documents, making sure it is different from previous queries(if provided). your query is:\n",
        components={
